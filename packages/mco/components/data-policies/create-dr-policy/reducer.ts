...
export type ManagedClusterView = {
  subscription?: SubscriptionKind;
  storageSystem?: StorageSystemKind;
  cephCluster?: CephClusterKind;
  subscriptionViewLoaded: boolean;
  storageSystemViewLoaded: boolean;
  cephClusterLoaded: boolean;
};

export type ClusterToManagedClusterView = {
  [clusterName: string]: ManagedClusterView;
};
...
export type DRPolicyState = {
  ...
  clusterToManagedClusterView: ClusterToManagedClusterView;
...
export enum DRPolicyActionType {
  ...
  SET_CLUSTER_TO_MANAGED_CLUSTER_VIEW = 'SET_CLUSTER_TO_MANAGED_CLUSTER_VIEW',
...
export type DRPolicyAction =
  ...
  | {
      ...
      payload: ClusterToManagedClusterView;
    }
...
export const drPolicyReducer = (
  ...
  switch (action.type) {
    ...
    case DRPolicyActionType.SET_CLUSTER_TO_MANAGED_CLUSTER_VIEW: {
      return {
        ...state,
        clusterToManagedClusterView: action.payload,
      };
    }
